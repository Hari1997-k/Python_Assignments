...
i = index positon of non leafnode in the tree
formula for finding NonLeafNode_Index  = (size//2)+1 ===> (Bcoz ARRAYSIZE starts from '0')
formula for finding Left_Child_Index = (NonLeafNode_Index * 2)+1
formula for finding Ryt_Child_Index = (NonLeafNode_Index * 2)+2
...
def Finding_MaxHeap(alst, size, i):
    ...
    if largest != i:
        alst[i], alst[largest] = alst[largest], alst[i]  # swap
